...
indexName="machinestotal"
tempPath="/root/you/Machinestotal/"
...
GetRawdata=`curl -k -X GET "https://oct1/odata/Machines" -H "accept: application/json" -H "Authorization: Bearer ${GetToken}"`
